# BW16-AdvWiFiScan
Advanced WIFI Networks scan using BW16 (RTL8720DN) <br>
Scanning may reveal SSID, BSSID, RSSI, Security, Vendor and Type of networks <br>
BD include in 6367 unique OUI(MAC) for determining the router manufacturer
...
2. Open the folder and open `AdvScanBW16.ino` in Arduino IDE.
...
7. Upload the code.
   - Open Serial Monitor (115200), board is automatically scanning networks.
